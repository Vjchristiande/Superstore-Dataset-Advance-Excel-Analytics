...
<ol>
<li> **Yearly Revenue Chart** Created a "Progress to Goal" chart for Technology sales against a PHP 100,000 target, connecting it to Slicers so the entire view updates dynamically by city or segment. </li>
